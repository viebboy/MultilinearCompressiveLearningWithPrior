...
def main(argv):
    ...
    parameters = [Conf.autoencoder_names,]*2
    values = [Conf.autoencoder_conf, Conf.autoencoder_semi_supervised_conf]
    ...
    output = Runners.train_autoencoder(configurations[index])
