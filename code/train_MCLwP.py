...
def main(argv):
    ...
    parameters = [Conf.mclwp_names,]*3
    values = [Conf.mclwp_conf, Conf.mclwp_complexity_conf, Conf.mclwp_semi_supervised_conf]
    ...
    output = Runners.train_MCLwP(configurations[index])
